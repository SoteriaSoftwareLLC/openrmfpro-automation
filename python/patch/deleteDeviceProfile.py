...
# ex: python3 deleteDeviceProfile.py http://192.168.13.111:8080 openrmfprosvc hvs.xxxxxxxxxxxxxx degthatnetwork 6671c5b3b4268ee3a8c11d57
...
if len(sys.argv) < 6:
    print("Usage: python3 deleteDeviceProfile.py <URL> <applicationKey> <token> <systemKey> <profileId>")
    sys.exit(1)
...
try:
    ...
    if resp.status_code == 200:
        print(f"Device Profile for ID {profile_id} deleted successfully.")
    else:
        print("Error deleting Device Profile:")
        print(resp.text)
