...
# ex: python3 uploadOrganizationTemplateChecklist.py http://192.168.13.111:8080 package-key openrmfprosvc hvs.xxxxxxxxxxxxxxxx "My title" "My description" ../data/ checklist.ckl
