# list all the other tech vulnerability score totals by category in a system package
...
# ex: python3 listSystemPackageTechVulnerabilitiesScoreByCategory.py http://192.168.13.111:8080 companyinfra openrmfprosvc hvs.xxxxxxxxxxxxxx
