...
url = sys.argv[1] + "/api/external/systempackage/" + sys.argv[2]+ "/techvulnerabilityscorehistory/" + sys.argv[3] + "/source/" + escape(sys.argv[4]) + "/project/" + escape(sys.argv[5]) + "/?applicationKey=" + sys.argv[6]
