...
url = myVariables.rootURL + "/api/external/systempackage/machina-biometric/poam/?applicationKey=" + myVariables.applicationKey
...
poamTable = PrettyTable(["Title", "Key", "Poam Id"])
# Just get the fields want
for element in json_object:  # iterate on each element of the list
    poamTable.add_row([element['systemTitle'], element['systemKey'], element['poamItemId']])
