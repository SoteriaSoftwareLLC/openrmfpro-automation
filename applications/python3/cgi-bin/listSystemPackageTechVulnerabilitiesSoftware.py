...
url = myVariables.rootURL + "/api/external/systempackage/" + str(arguments["systemKey"][0]) + "/techvulnerabilitydata/?categoryType=10&applicationKey=" + myVariables.applicationKey
