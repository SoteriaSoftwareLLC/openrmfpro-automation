...
url = myVariables.rootURL + "/api/external/systempackage/" + str(arguments["systemKey"][0]) + "/patchscore/devices/?applicationKey=" + myVariables.applicationKey + "&devices=degthat"
